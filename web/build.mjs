...
await writeFile(path.join(destination,'package.json'),JSON.stringify({name:'decisiongate-web',version:'0.2.0',private:true,type:'module',exports:{'.':{types:'./index.d.ts',import:'./index.js'}}},null,2)+'\n');
