# DecisionGator for Node.js and TypeScript

Your software probably needs this.

```typescript
import { isYes } from 'decisiongator';
...
```typescript
import { choose } from 'decisiongator';
