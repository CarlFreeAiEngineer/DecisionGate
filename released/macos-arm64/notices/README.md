...
Project source is MIT. Original example data is offered under the CC0 terms described in `data/README.md`. Fine-tuned weights retain their respective base model's terms (MIT for v0.1, Apache-2.0 for v0.2); the training recipe and exact source checkpoint are recorded with the bundle and reports.
