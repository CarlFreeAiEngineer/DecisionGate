...
- `decisiongator-java-0.4.1.jar`: Java 17 API, including `Decisions.isYes(...)`, `Decisions.isYesP(...)`, `Decisions.choose(...)`, and `Decisions.chooseP(...)`.
- `decisiongator-java-0.4.1-macos-arm64.jar`: bundled Mac native libraries, weights, tokenizer, manifest, and notices.
- `decisiongator-java-0.4.1-linux-x64.jar`: the corresponding Linux x64 bundle.
- `decisiongator-java-0.4.1-windows-x64.jar`: the corresponding Windows x64 bundle.
- `decisiongator-java-0.4.1-sources.jar` and `decisiongator-java-0.4.1-javadoc.jar`: sources and API documentation.
- `decisiongator-java-0.4.1.pom`: dependency metadata, including JNA.
