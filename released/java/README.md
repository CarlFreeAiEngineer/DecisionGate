...
Local version 0.4.0 artifacts, not yet published to Maven Central:

- `decisiongate-java-0.4.0.jar`: Java 17 API, including `Decisions.isYes(...)`, `Decisions.isYesP(...)`, `Decisions.choose(...)`, and `Decisions.chooseP(...)`.
- `decisiongate-java-0.4.0-macos-arm64.jar`: bundled Mac native libraries, weights, tokenizer, manifest, and notices.
- `decisiongate-java-0.4.0-linux-x64.jar`: the corresponding Linux x64 bundle.
- `decisiongate-java-0.4.0-windows-x64.jar`: the corresponding Windows x64 bundle.
- `decisiongate-java-0.4.0-sources.jar` and `decisiongate-java-0.4.0-javadoc.jar`: sources and API documentation.
- `decisiongate-java-0.4.0.pom`: dependency metadata, including JNA.
