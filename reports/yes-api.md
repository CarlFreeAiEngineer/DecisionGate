# DecisionGate yes/no API validation
...
The product is now branded DecisionGate. Existing package identifiers and binary names are retained; see [the component specification](../specs/component-api.md).
